  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="relative w-full h-full bg-navy-900" style={{ height: '100vh' }}>
      ...
      <GoogleMap
        ...
        options={{ zoom: 14, center: { lat: coordinates[0], lng: coordinates[1] }, mapTypeControl: false, fullscreenControl: false, streetViewControl: false, styles: darkMapStyle, backgroundColor: '#1a1f3a' }}
        onClick={handleMapClick}
      >
        {selectedPin && (
          <MarkerF
            position={{ lat: selectedPin.lat, lng: selectedPin.lng }}
            icon={{ path: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z', fillColor: '#ff9d56', fillOpacity: 1, strokeColor: '#fff', strokeWeight: 2, scale: 2 }}
          />
        )}
      </GoogleMap>
      {!selectedPin && (
