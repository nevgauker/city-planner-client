...
export default function TripDetailsStage({ city, onSubmit, onBack }: Props) {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="relative w-full h-full bg-gradient-to-b from-navy-900 to-navy-800 flex flex-col items-center justify-center p-3 sm:p-4 overflow-y-auto">
