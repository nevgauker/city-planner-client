      ...
      <div className="glass-effect card-elevation rounded-lg p-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={isLoading}
            className="flex-1 px-4 py-2 border border-white/30 rounded-lg text-white hover:bg-white/10 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            <X className="w-4 h-4" />
            Change
          </button>
