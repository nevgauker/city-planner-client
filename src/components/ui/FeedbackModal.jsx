    ...
    >
      ...
      >
        <h2 className='text-2xl font-bold mb-2'>
          How was your {city} itinerary?
        </h2>
        <p className='text-white/60 text-sm mb-6'>
          Your feedback helps us improve City Planner
        </p>
        ...
        <div className='space-y-6'>
          ...
          <div>
            <label className='block text-white/80 text-sm mb-2'>
              What did you love or want to improve? (optional)
            </label>
            <textarea
              value={comment}
          ...
          <div>
            <p className='text-white/80 text-sm mb-3'>
              Would you recommend City Planner to a friend?
            </p>
          ...
          <div className='flex gap-3 pt-4'>
            <motion.button
              onClick={handleDismiss}
              className='flex-1 py-3 px-4 border border-white/20 bg-white/10 hover:bg-white/20 text-white rounded-lg font-medium transition-colors'
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Not now
